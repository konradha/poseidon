#!/bin/bash
#SBATCH --job-name=poseidon_finetune_l
#SBATCH --ntasks=4
#SBATCH --mem-per-cpu=16G
#SBATCH --time=12:00:00
#SBATCH --gpus-per-node=1
#SBATCH --output=logs/%j/poseidon_finetune_l_%A_%a.out
#SBATCH --error=logs/%j/poseidon_finetune_l_%A_%a.err
...
CKPT_DIR="$SCRATCH/poseidon_checkpoints_l/${RUN_NAME}"
mkdir -p ${CKPT_DIR}
